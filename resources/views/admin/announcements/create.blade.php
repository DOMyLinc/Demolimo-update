    ...
    <div class="max-w-3xl mx-auto">
        <div class="card">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-bold text-white">Create New Announcement</h2>
            ...
            <form action="{{ route('admin.announcements.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="message" rows="4" required
                        class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-red-500 outline-none transition">{{ old('message') }}</textarea>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label for="is_active" class="text-white">Active immediately</label>
                </div>
